...
KeyValuePair newKeyValuePairs[] = {
    ...
    {376, "哦哦。。。你想領養我創造的寵物啊！有些事情我必須告訴你！我是開采生命水的魔法師。\r\n\r\n那些寵物是我在娃娃身上加上生命水後，再用魔法創造的魔法生命。我研究有關生命的魔法已經很長時間了，終於發現了創造生命的魔法。但還是有缺點，那就是－－沒有生命水，這魔法也會消失。而且生命水每次采集的數量很少。所以那些寵物，那些寵物每隔一段時間都需要復活一次。。。"},
    {377, "當生命水消耗完的時候，它就會回到娃娃的狀態。雖然這是很悲傷的事情，但也不必太傷心。用生命水就可以使它復活。為了能讓大家一直擁有可愛的寵物，我現在每天都在很深的地下開采生命水。如果以後你需要生命水的話，去找我的徒弟吧。你可別忘記，寵物的日子只有'90'天罷了。你千萬要珍惜它。。。"},
    {378, "結束了魔法的時間，不能動作下去。"},
    {379, "無法復活該寵物！\r\n您可在購物商場購買新的寵物。"},
    {380, "親密度增加 (+%d)"},
    {381, "親密度下降 (%d)"},
